...
create_project proj1 proj1 -part xc7z020clg400-1 -force
set_property board_part www.digilentinc.com:pynq-z1:part0:1.0 [current_project]

# Add RTL source files
add_files -norecurse {rtl/adder_16bit.sv rtl/full_adder.sv rtl/adder_16bit_wrapper.v}
...
create_bd_cell -type module -reference adder_16bit_wrapper adder_16bit_wrapper_0
#set_property location {3 250 -459} [get_bd_cells adder_16bit_wrapper_0]
# Connect adder outputs to GPIO inputs
connect_bd_net [get_bd_pins adder_16bit_wrapper_0/sum] [get_bd_pins axi_gpio_0/gpio_io_i]
connect_bd_net [get_bd_pins axi_gpio_1/gpio_io_o] [get_bd_pins adder_16bit_wrapper_0/a]
connect_bd_net [get_bd_pins axi_gpio_1/gpio2_io_o] [get_bd_pins adder_16bit_wrapper_0/b]
...
make_wrapper -files [get_files "${proj_path}/proj1.srcs/sources_1/bd/design_1/design_1.bd"] -top
add_files -norecurse "${proj_path}/proj1.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v"
update_compile_order -fileset sources_1
