...
\
  ...
  # Create instance: pipelined_adder_16bi_0, and set properties
  set block_name pipelined_adder_16bit_wrapper
  set block_cell_name pipelined_adder_16bi_0
  if { [catch {set pipelined_adder_16bi_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $pipelined_adder_16bi_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins pipelined_adder_16bi_0/s_axis]
  ...
  connect_bd_intf_net -intf_net pipelined_adder_16bi_0_m_axis [get_bd_intf_pins pipelined_adder_16bi_0/m_axis] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  [get_bd_pins pipelined_adder_16bi_0/c2]
  connect_bd_net -net axi_gpio_0_gpio_io_o  [get_bd_pins axi_gpio_0/gpio_io_o] \
  [get_bd_pins pipelined_adder_16bi_0/c1]
  ...
  [get_bd_pins pipelined_adder_16bi_0/aclk] \
  ...
  [get_bd_pins pipelined_adder_16bi_0/aresetn] \
